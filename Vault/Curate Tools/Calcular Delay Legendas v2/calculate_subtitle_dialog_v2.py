...
def compare_subtitles(bd_file, web_file):
    """Compara as legendas dos arquivos BD e WEB-DL, alinhando falas por similaridade ou exibindo diretamente se idiomas diferentes."""
    try:
        ...
        # Calcula limite de tempo dinâmico (90% da duração do BD)
        max_time = bd_selected_sub["duration"] * 0.9
